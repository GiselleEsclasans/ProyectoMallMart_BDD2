          ...
          <div className="flex items-center mt-2.5 mb-5">
            ...
            <div className="flex items-center space-x-1 rtl:space-x-reverse">
              ...
              {Array.from({ length: 5 }, (_, index) => (
                <svg key={index} className="w-4 h-4 text-rojoapagado drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
